...
export type McpDirectoryInfo = {
  ...
  command?: string[];
  oauth: boolean;
  /** Route OAuth through the local myai gateway instead of delegating it to OpenCode. */
  managedOAuth?: boolean;
  /** Identifies MCP entries owned by myai Connect instead of workspace configuration. */
  ...
  /** Whether myai should show this extension as enabled before user setup. */
  defaultEnabled?: boolean;
  /** Whether myai should hide this extension from the default catalog view. */
