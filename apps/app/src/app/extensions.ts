...
export const BUILT_IN_OPENWORK_EXTENSION_MANIFESTS: OpenWorkExtensionManifest[] = [
  {
    ...
    id: "openwork-browser",
    name: "myai Browser",
    description: "Automate the built-in browser panel that stays visible inside myai.",
    source: { format: "openwork-builtin", origin: "builtin", trusted: true },
    icon: { src: "/openwork-mark.svg" },
    composer: { prompt: "Use the myai Browser extension to " },
    setup: {
      instructions: "myai Browser is ready by default in desktop workspaces.",
    },
    resources: [
      {
    ...
    contributions: [
      ...
      { type: "composer-prompt", prompt: "Use the myai Browser extension to ", location: "composer" },
    ],
    enablement: [
  ...
  },
  {
    ...
    id: "openwork-voice",
    name: "Voice Mode",
    description: "Talk to myai through a Realtime voice panel that drives the same semantic UI controls as myai UI MCP.",
    preview: true,
    source: { format: "openwork-builtin", origin: "builtin", trusted: true },
    icon: { src: "/openwork-mark.svg" },
    composer: { prompt: "Use Voice Mode to " },
    setup: {
      instructions: "Voice Mode uses OpenAI Realtime. Save an OpenAI API key in myai env vars, then open the session rail panel and speak or send a typed voice command.",
