    ...
    <SettingsSection>
      <LayoutSectionItem>
        <LayoutSectionItemHeader>
          ...
          <LayoutSectionItemDescription>
            Keep selected sites signed in by reading one browser profile. myai never changes the source browser, and sync starts only after you choose sites and enable it.
          </LayoutSectionItemDescription>
        </LayoutSectionItemHeader>
          ...
          {!syncState ? (
            ...
            <div className="flex flex-col gap-4" data-testid="login-sync-configured">
              <div className="grid gap-2 rounded-2xl border border-dls-border px-4 py-3 text-sm sm:grid-cols-2">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Synced cookies managed by myai</p>
