    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-lg sm:max-w-lg" data-testid="login-sync-dialog">
        <DialogHeader>
          ...
          <DialogDescription>
            While enabled, myai keeps reading only the browser profile and sites you select. It never changes the source browser.
          </DialogDescription>
        </DialogHeader>
            ...
            {sensitiveSites.length > 0 ? (
              <div className="flex flex-col gap-2">
                <p className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
                  <ShieldAlert className="size-3.5" /> Unchecked on purpose. Select only sites you want myai to use.
                </p>
