  ...
  return (
    <Card variant="outline" size="sm">
      <CardHeader>
        ...
        <CardDescription>
          Approve one Mac app, choose its window, and decide how myai can help. Your input interrupts control; Stop in the preview ends access.
        </CardDescription>
        <CardAction>
      ...
      <CardContent className="space-y-5">
        <div className="flex items-center gap-2 rounded-xl border border-border bg-muted/40 px-3 py-3 text-sm" role="status" aria-live="polite">
          ...
          <span>{ready ? "Ready · app access is approved when a session starts" : !supported ? "Available in myai for macOS 14 or later" : !connected ? permissionsReady ? "Permissions are ready. Enable Computer Use for this workspace." : "Set up Computer Use for this workspace" : "Connected · finish macOS permissions below"}</span>
        </div>
        {!ready ? (
