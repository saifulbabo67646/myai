...
export function ComputerUseConfig({
  ...
  const {
    ...
    mutationFn: async () => {
      if (!hasDesktopBridge()) {
        throw new Error("Computer Use is Mac only and requires the myai desktop app on macOS.");
      }
    ...
    <Card variant="outline" size="sm">
      ...
      <CardContent className="space-y-4">
        ...
        <SetupRow
          ...
          description="Opens the myai Computer Use helper. Grant both permissions there, then click Verify below."
          complete={allGranted}
        >
