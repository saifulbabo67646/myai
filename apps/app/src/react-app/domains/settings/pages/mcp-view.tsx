...
export type McpViewProps = {
  ...
  /** MCP capabilities assigned through myai Connect. */
      ...
      {detailSkill ? (() => {
        ...
        return (
          <ExtensionDetailModal
            ...
            taxonomy="skill"
            connected={true}
            connectedLabel={detailSkill.origin === "openwork-connect" ? "Available through myai Connect" : undefined}
            hidden={hidden}
    ...
    <section className="w-full max-w-3xl animate-in fade-in duration-300">
      ...
      {props.builtInExtensionsDisabled ? (
        <div className="mb-5 rounded-xl border border-amber-6 bg-amber-2 px-4 py-3 text-xs text-amber-11">
          Built-in myai extensions are disabled by your organization. Use Show hidden to review blocked built-ins.
        </div>
      ) : null}
