        ...
        {props.cloudMcpHealth ? (
          <div className="space-y-2 rounded-xl border border-gray-6 bg-gray-1/60 p-3">
            <div className="grid gap-2">
              ...
              {compatibility ? (
                <>
                  <DiagnosticRow label="myai versions" value={`server ${formatMaybe(compatibility.openwork.serverVersion)}; app ${formatMetadataRecord(compatibility.openwork.app)}`} />
  ...
  return (
    <LayoutSection>
      <LayoutSectionHeader>
        ...
        <LayoutSectionDescription>
          Inspect what myai controls at runtime versus what belongs to your workspace config. This works through the OpenWork server and does not require the OpenCode engine to be healthy.
        </LayoutSectionDescription>
      </LayoutSectionHeader>
        ...
        {props.configStatus ? (
          <div className="space-y-3 rounded-xl border border-gray-6 bg-gray-1/60 p-3 text-xs text-gray-10">
            <div className="space-y-2 rounded-xl border border-blue-6/50 bg-blue-2/40 p-3">
              <div className="font-medium text-gray-12">Desired myai runtime config</div>
            ...
            {props.configStatus.sources ? (
              <div className="space-y-3">
                <div>
                  ...
                  <div className="text-[11px] text-gray-9">
                    OpenCode also reads its own project and global config files. myai injects the runtime config separately; for OpenWork-managed keys, the injected config is the source to inspect.
                  </div>
                </div>
                ...
                />
                <RuntimeConfigSourceBlock
                  title="myai injected config"
                  description="The object myai injects into OpenCode at runtime."
