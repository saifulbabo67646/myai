      ...
      <Page>
        ...
        <PageContainer>
          <PageHeader>
            ...
            <PageDescription>
              Restart myai once to finish applying {orgName || "your workspace"}&apos;s name and app icon everywhere.
            </PageDescription>
      ...
      <PageContainer>
        ...
        <PageHeader>
          {prepared ? (
            ...
            >
              <CheckCircle2 className="size-3.5" />
              Setup complete — myai prepared this workspace
            </div>
          ) : null}
          <PageTitle>
