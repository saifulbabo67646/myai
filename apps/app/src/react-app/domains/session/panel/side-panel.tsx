...
The artifact preview keeps **outside-chat Markdown** readable with inline \`surface renderer\`, a fenced code block, and [myai](https://example.test/docs).
  ...
  const seedPdfArtifactControlAction = React.useMemo<OpenworkControlAction | null>(() => {
    ...
    return {
      ...
      execute: async () => {
        ...
        // Minimal single-page PDF that draws "myai PDF" — base64 encoded.
        const pdfBase64 =
