...
export function SessionPage(props: SessionPageProps) {
  ...
  const openBrowserUrlControlAction = useMemo<OpenworkControlAction>(() => ({
    ...
    description: "Create or select a myai built-in browser tab, navigate it to a URL, and return the CDP handle for browser automation.",
  ...
  const focusWorkbenchSessionControlAction = useMemo<OpenworkControlAction>(() => ({
    ...
    args: [{
      ...
      type: "string",
      required: true,
      description: "Session id from the myai context resources or conversation tabs.",
    }],
    execute: (args) => {
