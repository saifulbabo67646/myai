...
export type ExtensionDetailModalProps = {
  ...
  /** Show the local stdio wrapper setup used by the myai UI MCP. */
  uiControl?: boolean;
  connected?: boolean;
...
const taxonomyDesc: Record<ExtensionTaxonomy, string> = {
  ...
  plugin: "Extends myai with additional capabilities managed by your organization.",
};
      ...
      <Card variant="outline" size="sm">
        ...
        <CardContent>
          <div className="flex flex-col gap-2 text-sm leading-relaxed text-muted-foreground">
            <div>myai desktop starts a private localhost bridge automatically.</div>
