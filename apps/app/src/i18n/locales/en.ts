 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, myai) are NOT translated
 */
...
export default {
  ...
  "connect.pitch_title": "Connect is the new way myai lets you share workflows with your team.",
  ...
  "connect.state_unavailable_action": "Restart myai. If this continues, run diagnostics.",
  ...
  "context_panel.permission_source_openwork": "myai",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update myai and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and myai will reconnect here automatically.",
  ...
  "den.error_paste_valid_code": "Paste a valid myai sign-in link or one-time sign-in code.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into myai automatically, paste the sign-in link or one-time code from OpenWork Cloud here.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect myai.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the myai link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect myai.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the myai link, then paste it below.",
  ...
  "den.status_server_config_cleared": "Cleared the desktop server configuration. myai is using the default Cloud control plane.",
  ...
  "extensions.add_picker_hint": "Create something in myai, add an MCP server by URL, or manage a hosted service connection in Den.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the myai app.",
  ...
  "extensions.builtins_disabled_notice": "Built-in myai extensions are disabled by your organization.",
  ...
  "extensions.marketplace_description": "Browse myai built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through OpenWork Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace. This setup stays separate from organization-managed services in myai Connect.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so myai can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, myai needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, myai needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize myai",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from myai.",
  ...
  "mcp.name_reserved_openwork_connect": "This name is reserved for myai Connect. Choose a different name for the workspace MCP.",
  "mcp.no_apps_hint": "Connect one above to get started.",
  "mcp.no_apps_yet": "No apps connected yet",
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in this device's protected app storage. This is separate from myai Connect and does not connect other devices.",
  ...
  "mcp.oauth_secret_warning": "myai encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the myai app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "myai UI Control",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. myai will use it before sign-in and cloud features.",
  ...
  "welcome.use_cloud_subtitle": "Sign in for hosted myai and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. myai will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and myai can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. myai will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like an myai invite link, install link, server URL, or sign-in code.",
  ...
  "join_org.error_network": "myai could not reach that organization server. Check your connection or VPN, then try again.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. myai now points at {host} and is ready when you come back.",
  ...
  "settings.privacy_section_desc": "Control what myai shares to improve the product.",
  ...
  "settings.custom_binary_hint": "Use this to point myai at a local OpenCode build",
  ...
  "settings.runtime_config_one_writer_rule": "myai writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which myai events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by myai. Off by default.",
  ...
  "settings.feedback_title": "Help shape myai",
  ...
  "settings.nuke_confirmation_hint": "myai will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local myai, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed myai app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's myai state (.opencode/openwork) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste a myai deeplink or share URL to open it.",
  ...
  "settings.organization_server_desc": "Point myai at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's OpenWork server URL. Saving signs you out so myai can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by myai.",
  ...
  "settings.quit_hint": "myai quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears myai cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears myai cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. myai will restart.",
  ...
  "settings.reset_onboarding_description": "Clears myai preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears myai local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset myai + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but myai will wait until your active tasks finish before restarting. You can also stop them manually.",
  ...
  "settings.services_section_desc": "Local services that power this myai session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting myai.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs myai will use after local overrides and bootstrap files are applied.",
  ...
  "settings.tab_connect": "myai Connect",
  ...
  "settings.tab_description_appearance": "Adjust how myai looks across desktop, system theme, and app frame.",
  ...
  "settings.environment.override_hint": "Environment variables set before myai starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "myai will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "myai is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but myai status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by myai/OpenCode.",
  ...
  "settings.update_blocked_org": "myai {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  "settings.update_blocked_policy": "myai {version} is available, but this installation is not eligible for it yet.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts myai and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts myai now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep myai up to date.",
  ...
  "status.limited_hint": "Reconnect to restore full myai features",
  ...
  "status.openwork_ready": "myai Ready",
  ...
  "system.reload_body_default": "myai detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "myai detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "myai can't load tasks from this worker until the connection is fixed.",
