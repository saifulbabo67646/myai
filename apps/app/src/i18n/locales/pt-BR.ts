 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, myai) NÃO são traduzidos
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "O servidor myai está em modo somente leitura para plugins.",
  "app.reload_later": "Depois",
  "app.reload_now": "Recarregar agora",
  "app.reload_stop_tasks": "Recarregar e Parar Tarefas",
  "app.skills_hint_readonly": "O servidor myai está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao myai!\n\nAs pessoas usam o myai para escrever arquivos .csv no computador, automatizar tarefas no navegador e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao myai",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores myai conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor myai necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor myai. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  "config.server_section_title": "Servidor myai",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor myai",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor myai. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor myai",
  "config.server_url_label": "URL do Servidor myai",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace myai com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor myai não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor myai está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor myai desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace myai com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker myai auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker myai auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor myai como workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor myai para este workspace.",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker myai auto-hospedado.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o myai reconectará aqui automaticamente.",
  ...
  "den.cloud_provider_needs_server": "Requer o servidor myai",
  ...
  "den.error_paste_valid_code": "Cole um link de login do myai válido ou um código de uso único.",
  ...
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o myai automaticamente, cole o link de login ou código de uso único do OpenWork Cloud aqui.",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o myai.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o myai.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o myai as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o myai precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o myai precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o myai",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo myai.",
  ...
  "session.share_local_host_not_ready": "O host local do myai ainda não está pronto.",
  "session.share_missing_host_url": "URL do host myai ausente.",
  "session.share_missing_token": "Token do myai ausente.",
  ...
  "session.share_openwork_workers_only": "Links de compartilhamento estão disponíveis para workers myai.",
  ...
  "settings.background_checks_desc": "O myai sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor myai",
  ...
  "settings.custom_binary_hint": "Use para apontar o myai para um build local do OpenCode",
  ...
  "settings.debug_openwork_server_version": "Servidor myai: {version}",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo myai",
  "settings.docker_containers_title": "Containers Docker do myai",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o myai inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o myai",
  ...
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do myai para abrir.",
  ...
  "settings.openwork_diagnostics_title": "Diagnósticos do servidor myai",
  "settings.openwork_server_desc": "Plano de controle de sessão para sincronização do app, workers e acesso remoto.",
  "settings.openwork_server_label": "Servidor myai",
  ...
  "settings.quit_hint": "O myai fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor myai.",
  "settings.reconnected": "Reconectado ao servidor myai.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do myai.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do myai neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O myai será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do myai e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no myai.",
  ...
  "settings.reset_openwork_title": "Redefinir estado do myai + OpenCode",
  ...
  "settings.restart_blocked_message": "O myai precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor myai.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do myai no desktop, tema do sistema e decoração do app.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace myai selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o myai atualizado.",
  ...
  "share_skill_destination.connect_remote_hint": "Vincule um host myai e selecione-o na lista para importar esta skill.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor myai conectado.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do myai",
  ...
  "status.openwork_ready": "myai Pronto",
  ...
  "system.reload_body_default": "O myai detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O myai detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "O myai não consegue carregar tarefas deste worker até que a conexão seja corrigida.",
