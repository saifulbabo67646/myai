/**
 * 中文（简体）翻译
 * 产品名称保留英文：OpenCode、OpenPackage、myai
...
export default {
  ...
  "app.plugins_hint_readonly": "myai服务器对插件为只读模式。",
  "app.reload_later": "稍后",
  "app.reload_now": "立即重新加载",
  "app.reload_stop_tasks": "重新加载并停止任务",
  "app.skills_hint_readonly": "myai服务器对skills为只读模式。请在高级设置中添加主机令牌以启用安装。",
  ...
  "blueprint.welcome_message": "你好，欢迎使用myai！\n\n大家用myai在电脑上编写CSV文件、自动化浏览器任务，以及将联系人同步到Notion。\n\n但唯一的限制是你的想象力。\n\n你想做什么？",
  "blueprint.welcome_title": "欢迎使用myai",
  "common.add": "添加",
  "common.cancel": "取消",
  "common.close": "关闭",
  ...
  "config.reload_availability_hint": "仅本地工作区或已连接的myai服务器支持重新加载。",
  ...
  "config.server_needed_hint": "需要连接myai服务器以同步skills、插件和命令。",
  "config.server_section_desc": "连接myai服务器。使用URL加服务器管理员提供的协作者或所有者令牌。",
  "config.server_section_title": "myai服务器",
  "config.server_sharing_desc": "将这些详情分享给受信任的设备。保持服务器在同一网络以获得最快设置。",
  "config.server_sharing_menu_hint": "如需每个工作区的分享链接，请使用工作区菜单中的分享…",
  "config.server_sharing_title": "myai服务器共享",
  "config.server_url_hint": "使用myai服务器提供的URL。本地桌面工作区使用48000-51000范围内的持久高端口。",
  "config.server_url_input_label": "myai服务器URL",
  "config.server_url_label": "myai服务器URL",
  ...
  "context_panel.authorized_folders_no_access": "连接可写的myai服务器工作区以编辑已授权文件夹。",
  "context_panel.browse_button": "浏览",
  "context_panel.config_access_unavailable": "此工作区无法访问myai服务器配置。",
  "context_panel.config_read_only": "myai服务器对工作区配置为只读连接。",
  ...
  "dashboard.create_remote_custom_subtitle": "连接自托管的myai工作区。",
  "dashboard.create_remote_custom_title": "连接自定义远程",
  "dashboard.create_remote_workspace_confirm": "添加工作区",
  "dashboard.create_remote_workspace_subtitle": "保存myai服务器为工作区。",
  ...
  "dashboard.edit_remote_workspace_subtitle": "更新此工作区的myai服务器信息。",
  ...
  "dashboard.remote_server_details_hint": "连接自托管的myai工作区。",
  ...
  "den.auto_reconnect_hint": "在浏览器中完成认证后，myai将自动重新连接。",
  ...
  "den.cloud_provider_needs_server": "需要myai服务器",
  ...
  "den.error_paste_valid_code": "请粘贴有效的myai登录链接或一次性登录码。",
  ...
  "den.signin_link_hint": "如果浏览器未自动跳回myai，请在此粘贴OpenWork Cloud的登录链接或一次性登录码。",
  ...
  "den.status_browser_signin": "请在浏览器中完成登录以连接myai。",
  "den.status_browser_signup": "请在浏览器中完成账户创建以连接myai。",
  ...
  "mcp.apps_subtitle": "连接常用工具，让myai代你使用。",
  "mcp.apps_title": "应用",
  ...
  "mcp.auth.reload_notice": "要使更改生效，myai需要刷新worker服务。这可能会中断正在运行的会话。",
  "mcp.auth.reload_remote_confirm": "要使更改生效，myai需要刷新worker服务。这可能会停止你正在运行的会话。是否继续？",
  ...
  "mcp.login_unavailable": "此应用不支持从myai发起登录。",
  ...
  "session.share_local_host_not_ready": "本地myai主机尚未就绪。",
  "session.share_missing_host_url": "缺少myai主机URL。",
  "session.share_missing_token": "缺少myai令牌。",
  ...
  "session.share_openwork_workers_only": "分享服务链接仅适用于myai工作区。",
  ...
  "settings.background_checks_desc": "myai启动时始终检查。同时每天检查一次。",
  ...
  "settings.capabilities_title": "myai服务器功能",
  ...
  "settings.custom_binary_hint": "用于将myai指向本地的OpenCode构建",
  ...
  "settings.debug_openwork_server_version": "myai服务器：{version}",
  ...
  "settings.docker_containers_desc": "强制移除myai启动的Docker容器",
  ...
  "settings.enable_exa_desc": "在myai启动OpenCode时生效。",
  ...
  "settings.environment.override_hint": "myai 启动前已经存在的环境变量，会优先于这里保存的值。",
  ...
  "settings.environment.apply_confirm_body": "myai 会重启本机 agents，让它们使用最新环境变量。正在运行的本机任务可能会停止。",
  "settings.environment.apply_no_local_workspace": "myai 尚未连接到本机工作区。",
  ...
  "settings.environment.apply_refresh_failed": "更改已生效，但 myai 状态没有刷新。如果界面看起来过期，请重新打开应用。",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ 和 OPENCODE_ 名称由 myai/OpenCode 管理。",
  ...
  "settings.feedback_title": "帮助塑造myai",
  ...
  "settings.open_deeplink_desc": "粘贴myai深度链接或共享URL以打开。",
  ...
  "settings.openwork_diagnostics_title": "myai服务器诊断",
  "settings.openwork_server_desc": "用于应用同步、工作者和远程连接的会话控制平面。",
  "settings.openwork_server_label": "myai服务器",
  ...
  "settings.quit_hint": "myai在清理后立即退出，以便下次启动时从此模式的全新本地状态开始。",
  "settings.recent_events": "最近的事件",
  "settings.reconnect_failed": "重新连接失败。请检查服务器URL/令牌后重试。",
  "settings.reconnect_server": "正在重新连接…",
  "settings.reconnect_server_failed": "重新连接myai服务器失败。",
  "settings.reconnected": "已重新连接myai服务器。",
  ...
  "settings.reset_openwork_title": "重置myai + OpenCode状态",
  ...
  "settings.restart_blocked_message": "myai需要重启以完成此更新。为避免中断当前工作，安装已暂停，直到你的活动运行完成或你手动停止它们。",
  ...
  "settings.runtime_desc": "本地引擎和myai服务器的状态。",
  ...
  "settings.tab_description_appearance": "调整myai在桌面、系统主题和应用外观方面的显示效果。",
  ...
  "settings.tab_description_general": "连接提供商、选择默认模型、授权文件夹，以及控制所选myai工作区和运行时连接。",
  ...
  "settings.updates": "更新",
  "settings.updates_desc": "保持myai为最新版本。",
  ...
  "skills.host_only_error": "Skills管理需要本地工作区或已连接的myai服务器。",
  "skills.import": "导入",
  ...
  "status.docs": "文档",
  "status.feedback": "反馈",
  "status.limited_hint": "重新连接以恢复完整myai功能",
  ...
  "system.reload_body_default": "myai检测到需要重新加载OpenCode实例的变更。",
  "system.reload_body_mcp": "OpenCode在启动时加载MCP服务器。重新加载引擎以激活新连接。",
  "system.reload_body_mixed": "myai检测到OpenCode配置变更。重新加载引擎以应用。",
  ...
  "workspace_list.remote_worker_unavailable_hint": "连接修复前，myai 无法从这个远程工作区加载任务。",
