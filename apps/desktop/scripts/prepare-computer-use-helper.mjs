...
const packagePath = resolve(repoRoot, "packages", "computer-use", "native");
...
const helperAppName = "myai Computer Use.app";
const bundleIdentifier = "bd.myai.computer-use";
...
<dict>
  ...
  <string>myai Computer Use</string>
