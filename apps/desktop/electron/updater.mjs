...
// (e.g. "35.7.5") instead of the myai app version. Read from
...
const ELECTRON_UPDATER_FEEDS = Object.freeze({
  stable: "https://github.com/saifulbabo67646/myai/releases/latest/download",
  alpha: "https://github.com/saifulbabo67646/myai/releases/download/alpha-macos-latest",
});
...
export function targetedStableUpdaterFeed(currentVersion, targetVersion, allowOlder = false) {
  ...
  return `https://github.com/saifulbabo67646/myai/releases/download/v${normalizedTarget}`;
}
...
const SHIP_IT_DEFAULTS_DOMAIN = "bd.myai.app.ShipIt";
