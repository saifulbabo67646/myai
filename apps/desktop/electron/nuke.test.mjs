...
test("buildNukeManifest includes default macOS state roots and preserves bootstrap", () => {
  ...
  const userDataPath = "/Users/alice/Library/Application Support/bd.myai.app";
...
test("buildNukeManifest can include the bootstrap file in the wipe", () => {
  ...
  const manifest = buildNukeManifest({
    ...
    userDataPath: "/Users/alice/Library/Application Support/bd.myai.app",
  });
...
test("buildNukeManifest includes default Linux state roots", () => {
  const manifest = buildNukeManifest({
    ...
    homedir: "/home/alice",
    platform: "linux",
    userDataPath: "/home/alice/.config/bd.myai.app",
  });

  assert.equal(manifest.preserveBootstrapPath, "/home/alice/.config/openwork/desktop-bootstrap.json");
  assert.ok(manifest.deletePaths.includes("/home/alice/.config/bd.myai.app"));
...
test("buildNukeManifest includes Windows path shapes", () => {
  ...
  const manifest = buildNukeManifest({
    ...
    platform: "win32",
    userDataPath: "C:\\Users\\Alice\\AppData\\Roaming\\bd.myai.app",
  });

  assert.equal(manifest.preserveBootstrapPath, "C:\\Users\\Alice\\AppData\\Local\\openwork\\desktop-bootstrap.json");
  assert.ok(manifest.deletePaths.includes("C:\\Users\\Alice\\AppData\\Roaming\\bd.myai.app"));
...
test("buildNukeManifest honors OPENWORK_ELECTRON_USERDATA override", () => {
  ...
  assert.ok(!manifest.deletePaths.includes("/Users/alice/Library/Application Support/bd.myai.app"));
});
...
test("buildNukeManifest never reaches production state from a non-dev isolated profile", () => {
  const userDataPath = "/Users/alice/Library/Application Support/bd.myai.app.dev.wt2";
  const manifest = buildNukeManifest({
    env: { OPENWORK_ELECTRON_APP_IDENTIFIER: "bd.myai.app.dev.wt2" },
    homedir: "/Users/alice",
    platform: "darwin",
    userDataPath,
  });
  ...
  for (const productionPath of [
    ...
    "/Users/alice/Library/Caches/bd.myai.app.ShipIt",
  ]) {
