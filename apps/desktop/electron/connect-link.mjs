...
/**
 * Extracts the signed token from a connect deep link. Accepts the myai and
 * myai-dev schemes plus legacy openwork/openwork-dev, and both authority
 * forms (myai://connect and myai:///connect).
 *
 * @param {string} rawUrl
 * @returns {string | null}
 */
export function extractConnectLinkToken(rawUrl) {
  ...
  if (!["myai:", "myai-dev:", "openwork:", "openwork-dev:"].includes(parsed.protocol)) return null;
